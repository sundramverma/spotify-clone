        ...
        <div className='bg-[#003a10] min-h-screen pl-[4vw]'>
            ...
            <div className="flex flex-col gap-5 mt-10">
                ...
                <NavLink to={"/add-podcast"} className="flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr-[max(8vw,10px)] drop-shadow-[-4px_4px_#00ff5b] text-sm font-medium">
                    <img src={assets.add_song} className='w-5' alt="Add Podcast" />
                    <p className='hidden sm:block'>Add Podcast</p>
                </NavLink>
                
                <NavLink to={"/list-podcast"} className="flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr-[max(8vw,10px)] drop-shadow-[-4px_4px_#00ff5b] text-sm font-medium">
                    <img src={assets.song_icon} className='w-5' alt="List Podcast" />
